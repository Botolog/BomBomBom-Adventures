...
import { Vector2, Flags, iColorConv, Scene, SCENEMANAGER } from "./Engine.js";
...
let Me = new Player(SCENEMANAGER.noScene.entityManager, SCENEMANAGER.noScene.bodyManager);
Me.body.width = 20;
Me.body.height = 20;
...
export function keyInput(inputKeys) {
    if ("k" in inputKeys)
        moveCam(-15, 0);
    if (";" in inputKeys)
        moveCam(15, 0);
